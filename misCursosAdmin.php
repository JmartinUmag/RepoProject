            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="misCursosAdmin.php">Cursos</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col bg-dark bg-color m-md-5 my-3 mx-1 rounded">
                        <div class="mt-5">
                            <div class="d-md-flex">
                                <h2 class="flex-shrink-0 text-white mx-4">Cursos</h2>
                                <div class="input-group w-auto">
                                    <select class="form-select bg-dark text-white" id="inputGroupSelect01">
                                    <option value="Todos">Todos</option>
                                    <option value="Inscritos">Inscritos</option>
                                    <option value="Dictados">Dictados</option>
                                    </select>
                                </div>
                                <button type="button" class="ms-3 mt-3 mt-md-0 btn btn-outline-light">Añadir</button>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="editarCurso.php">
                                            <button type="button" class="btn btn-primary">
                                                ...
                                                <path d="M11.354 1.646a.5.5 0 0 1 .7 0l2.5 2.5a.5.5 0 0 1 0 .708l-9 9a.5.5 0 0 1-.31.146H2.5a.5.5 0 0 1-.5-.5V11a.5.5 0 0 1 .146-.35l9-9zM12 2.207l-2.5-2.5L12 0l2.5 2.5L12 5l-2.5-2.5L12 2.207z"/>
                                                <path d="M12.5 0l-9 9v2.5h2.5l9-9V.5a.5.5 0 0 0-.5-.5z"/>
                                                </svg>
                                                Editar
                                            </button>
                                        </a>
