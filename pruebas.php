        ...
        <body>
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Curso de PHP</h1>
                    <button type="button" class="btn btn-dark">Siguiente capítulo</button>
                    <div class="card m-3">
                        <div class="card-body">
                            <h4 class="display-8 fw-bolder text-black">Test capítulo 1</h4>
                    <p class="text-black lead">
                        https://forms.google.com/myforms
                    </p>
