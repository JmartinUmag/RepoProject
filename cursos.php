...
<html lang="es">
    ...
    <body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><hr class="dropdown-divider" /></li>
                                <li><a class="dropdown-item" href="cursos.php"></a>Backend</a></li>
                            </ul>
                        </li>
        ...
        <form class="d-flex pt-3">
            <div class="px-5 w-80 input-group">
                <input type="search" class="form-control rounded-star" placeholder="Buscar..." aria-label="Search" aria-describedby="search-addon" />
                ...
                <div class="modal fade" id="ModalDetalles" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-4">
                                <img src="img/logo.png" width="200" height="200" class="img-fluid" id="imagen"/>
                            </div>
                            </row>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                            <button type="button" class="btn btn-primary">Ver Curso</button>
                        </div>
                        </div>
                    </div>
                </div>
